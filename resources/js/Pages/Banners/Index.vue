					...
					<div class="flex items-center justify-between pb-6">
						...
						<div class="flex items-center justify-between">
							...
							<div class="lg:ml-40 ml-10 space-x-8">
								<form action="banners/create" method="CREATE">
									<button
										class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer hover:bg-indigo-500">
										Create Banner
									</button>
								</form>
							</div>
								...
								<table class="min-w-full leading-normal">
									...
									<tbody>
										<tr v-for="banner in banners.data" :key="banner.id"
											...
											<td class="border-t px-5 py-3">
												<Link class="text-green-700" :href="`/banners/${banner.id}/edit`">
												Edit
												</Link>
												<Link @click="destroy(banner.id)" class="text-red-700">
												Delete</Link>
											</td>
										</tr>
									</tbody>
